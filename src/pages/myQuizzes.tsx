      ...
      {deletionindex !== -1 ? (
        <div className="modal pt-5 pb-5 px-2">
          ...
          <h1 className=" mb-5 text-center">
            Deleting this will result in permanent deletion and is not
            recoverable
          </h1>
      ...
      {state !== null && state.length !== 0 ? (
        <div className="pl-0 ml-0 mr-0 bg-white sm:ml-12 sm:mr-20 sm:pl-12 rounded-2xl">
          ...
          {state.map((el, index) => (
            ...
            >
              <h1 className="text-center sm:text-justify">{index + 1}</h1>
              ...
              <h1 className="text-center sm:text-justify">{el.createdAt}</h1>
              <button
